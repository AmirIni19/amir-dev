...
<div class="wrap">
    <?php settings_errors(); ?>
	<h2><?php esc_html_e( 'استوری‌ها', 'wp-story' ); ?></h2>
	...
	<div class="information">
		<table class="form-table">
			<tr>
				<th><label for="display-editor"><?php esc_html_e( 'نمایش در ویرایشگر (کد کوتاه)', 'wp-story' ); ?></label>
				</th>
				<td>
			...
			<tr>
				<th><label for="display-editor"><?php esc_html_e( 'نمایش در کد (PHP)', 'wp-story' ); ?></label></th>
				<td>
