...
function flatsome_social_panels_sections( $wp_customize ) {
	...
	$wp_customize->add_section( 'share', array(
		...
		'description' => __( 'این تنظیمات پیش‌فرض برای کد کوتاه [share] و نمادهای اشتراک‌گذاری مختلف در وب‌سایت است.', 'flatsome-admin' ),
	) );

	$wp_customize->add_section( 'follow', array(
		'title'       => __( 'آیکون اشتراک گذاری', 'flatsome-admin' ),
		'panel'       => 'header',
		'description' => __( 'این تنظیمات پیش‌فرض برای کد کوتاه [دنبال کردن] و عنصر سرصفحه نمادهای اجتماعی است.', 'flatsome-admin' ),
	) );
}
...
Flatsome_Option::add_field( 'option',  array(
		...
		'label'       => __( 'آیکون های اشتراک گذاری', 'flatsome-admin' ),
...
Flatsome_Option::add_field( 'option',  array(
	...
	'label'       => __( 'اسنپ چت', 'flatsome-admin' ),
	'description' => 'یک تصویر Snapcode را در اینجا آپلود کنید. می توانید آن را در اینجا ایجاد کنید: https://accounts.snapchat.com/accounts/snapcodes',
	'section'     => 'follow',
	'transport' => $transport,
));
