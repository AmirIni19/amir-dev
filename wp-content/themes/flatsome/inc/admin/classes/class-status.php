	...
	public function section_overview() {
		...
		<div class="ux-status-overview">
			<ul class="ux-status-overview__list">
				<li class="ux-status-overview__list-item"><?php echo $this->icon['success'] ; ?><a href="<?php echo esc_url_raw( $panel_url . '#theme'); ?>"><?php esc_html_e( '  قالب', 'flatsome' ); ?></a></li>
<li class="ux-status-overview__list-item"><?php echo $indicator[ $this->wordpress_environment_group_test_result() ]; ?><a href="<?php echo esc_url_raw( $panel_url . '#wordpress' ); ?>"><?php esc_html_e( 'محیط وردپرس' ); ?></a></li>				<li class="ux-status-overview__list-item"><?php echo $indicator[ $this->server_environment_group_test_result() ]; ?><a href="<?php echo esc_url_raw( $panel_url . '#server' );  ?>"><?php esc_html_e( 'محیط سرور', 'flatsome' ); ?></a></li>
				<li class="ux-status-overview__list-item"><?php echo $indicator[ $this->security_group_test_result() ]; ?><a href="<?php echo esc_url_raw( $panel_url . '#security' ); ?>"><?php esc_html_e( 'امنیت', 'flatsome' ); ?></a></li>
				<li class="ux-status-overview__list-item"><?php echo $indicator[ $this->database_group_test_result() ]; ?><a href="<?php echo esc_url_raw( $panel_url . '#database' ); ?>"><?php esc_html_e( 'دیتابیس', 'flatsome' ); ?></a></li>
				<li class="ux-status-overview__list-item"><?php echo $indicator[ $this->templates_group_test_result() ]; ?><a href="<?php echo esc_url_raw( $panel_url . '#templates' ); ?>"><?php esc_html_e( 'قالب ها', 'flatsome' ); ?></a></li>
			</ul>
			<div class="ux-status-overview__actions">
				<a class="button button-large" href="<?php echo esc_url_raw( $panel_url ); ?>">
					<?php esc_html_e( 'اطلاعات بیشتر', 'flatsome' ); ?>
				</a>
			</div>
		</div>
		<?php
		...
		<table class="flatsome-status-table widefat" cellspacing="0">
			...
			<tr>
				<th colspan="3" data-export-label="Theme">
					<h2 id="theme"><?php esc_html_e( 'قالب', 'flatsome' ); ?></h2>
				</th>
			</tr>
			</thead>
			<tbody>
			...
			<tr>
				<td data-export-label="Author URL"><?php esc_html_e( 'پشتیبان قالب', 'flatsome' ); ?></td>
				<td class="help">
			...
			<tr>
				<td data-export-label="Registered"><?php esc_html_e( 'لایسنس', 'flatsome' ); ?></td>
				<td class="help">
				...
				<td>
					...
					<?php else : ?>
						<mark class="success"><span class="dashicons dashicons-warning"></span>
							<?php esc_html_e( 'قالب شما توسط تیم ایران فلتسام ثبت شده است.', 'flatsome' ); // dot is omitted as this string exist already. ?>
						</mark>
					<?php endif; ?>
				</td>
			</tr>
			<tr>
				<td data-export-label="Child Theme"><?php esc_html_e( 'قالب چایلد', 'flatsome' ); ?></td>
				<td class="help">
			...
			<tr>
				<td data-export-label="Release Channel"><?php esc_html_e( 'نسخه قالب', 'flatsome' ); ?></td>
				<td class="help">
